/**
 * GET /api/hr/payroll/staff/[staffProfileId] — a staff member's payroll history.
...
import { listPayrollForStaff } from "../../../../../../modules/hr/operations.service";
...
export async function GET(
  ...
  try {
    ...
    const records = await listPayrollForStaff(getDb(), staffProfileId, ctx);
